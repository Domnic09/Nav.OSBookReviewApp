...
namespace NavOS.Basecode.AdminApp.Authentication
{
    ...
    public class SignInManager
    {
        ...
        public ClaimsIdentity CreateClaimsIdentity(Admin user)
        {
            ...
            {
                new Claim(ClaimTypes.NameIdentifier, user.AdminEmail, ClaimValueTypes.String, Const.Issuer),
                new Claim(ClaimTypes.Name, user.AdminName, ClaimValueTypes.String, Const.Issuer),

                new Claim("Email", user.AdminEmail, ClaimValueTypes.String, Const.Issuer),
                new Claim("Name", user.AdminName, ClaimValueTypes.String, Const.Issuer),
            };
